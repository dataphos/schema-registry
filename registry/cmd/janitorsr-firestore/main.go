...
import (
	...
	"github.com/dataphos/aquarium-janitor-standalone-sr/registry/repository/firestore"
...
func main() {
	...
	srv := http.Server{
		...
		Handler: server.New(server.NewHandler(registry.New(db, compChecker, valChecker, globalCompMode, globalValMode), log)),
	}
